...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl = findViewById(R.id.relative_task);
...
//        navigationBottomView.setNavigationItemSelectedListener(this);
    ...
    public TodoList getListByID(int id) {
        for (TodoList currentList : todoLists) {
            if (currentList.getId() == id) return currentList;
        }
    ...
    private void sendToPomodoro(BaseTodo todo) {
        ...
        pomodoro.putExtra("todo_id", todoId).putExtra("todo_name", todoName).putExtra("todo_description", todoDescription).putExtra("todo_progress", todo.getProgress()).setPackage("org.secuso.privacyfriendlyproductivitytimer").setFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
    ...
    public void hints() {
        ...
        dbHelper = DatabaseHelper.getInstance(this);
        if (DBQueryHandler.getAllToDoTasks(dbHelper.getReadableDatabase()).size() == 0 && DBQueryHandler.getAllToDoLists(dbHelper.getReadableDatabase()).size() == 0) {
    ...
    public class OnCustomMenuItemClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            builder1.setPositiveButton(R.string.alert_delete_yes, new DialogInterface.OnClickListener() {
            ...
            builder1.setNegativeButton(R.string.alert_delete_no, new DialogInterface.OnClickListener() {
